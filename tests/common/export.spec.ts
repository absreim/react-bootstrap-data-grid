...
["community", "pro"].forEach((edition) => {
  ...
  test.describe(`${edition} export tests`, () => {
    ...
    test(`${edition} unformatted JSON export works correctly`, async ({
      page,
    }) => {
      const container = await openExport(
        page,
    ...
    test(`${edition} filtered JSON export works correctly`, async ({
      page,
    }) => {
      const container = await openExport(
        page,
    ...
    test(`${edition} formatted JSON export works correctly`, async ({
      page,
    }) => {
      const container = await openExport(
        page,
    ...
    test(`${edition} unformatted CSV export works correctly`, async ({
      page,
    }) => {
      const container = await openExport(
        page,
