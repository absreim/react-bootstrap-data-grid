...
const getUpArrow = (addlClasses?: string[]) => (
  ...
  >
    ...
    <desc>Up arrow indicating that the column is being sorted in an ascending manner</desc>
    <path
      fillRule="evenodd"
...
const downArrow = (
  ...
  >
    ...
    <desc>
      Down arrow indicating that the column is being sorted in an descending manner
    </desc>
    <path
      fillRule="evenodd"
