...
const SelectionInput: FC<SelectionInputProps> = ({ selectionInputModel, selected, selectCallback }) => {
  const type = selectionInputModel.type;

  const onChange: ChangeEventHandler<HTMLInputElement> = ({ target: { checked } }) => {
